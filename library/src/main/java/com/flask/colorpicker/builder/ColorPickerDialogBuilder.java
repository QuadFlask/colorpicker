...
public class ColorPickerDialogBuilder {
    ...
    public ColorPickerDialogBuilder setOnAlphaSelectedListener(OnAlphaSelectedListener onAlphaSelectedListener) {
        colorPickerView.addOnAlphaSelectedListener(onAlphaSelectedListener);
        return this;
    }

    public ColorPickerDialogBuilder setOnLightnessSelectedListener(OnLightnessSelectedListener onLightnessSelectedListener) {
        colorPickerView.addOnLightnessSelectedListener(onLightnessSelectedListener);
        return this;
    }
